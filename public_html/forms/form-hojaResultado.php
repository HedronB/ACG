                        ...
                        <?php foreach ($maquinas as $m): ?>
                            <tr>
                                <td style="text-align:center;">
                                    <a href="/reportes/hoja-resultado.php?id=<?= $m['ma_id'] ?>" class="btn-hoja btn-action-hoja">
                                        📝 Hoja de resultado
                                    </a>
                                </td>
...
<script>
    // --- LÓGICA DE FILTRADO Y PAGINACIÓN (Idéntica a list-molde-user.php) ---
    (function () {
        ...
        function aplicaFiltro() {
            ...
            const campo = campoFiltro.value; // all, 1 (Fecha), 2 (Marca), 3 (Modelo)
            ...
            if (!term) {
                ...
                filteredRows = rows.filter(row => {
                    ...
                    if (campo === 'all') {
                        ...
                        // Aseguramos que existe la celda antes de leer
                        if (celda = celdas[idx]) {
        ...
        if(btnExportCSV) btnExportCSV.addEventListener('click', () => {
            ...
            // Quitamos la columna de acciones (index 0) para el excel
